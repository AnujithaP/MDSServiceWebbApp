...
using MDSServiceWebbApp.Models.REST;
...
namespace MDSServiceWebbApp.Controllers
{
    ...
    public class PersonEntityController : Controller
    {
        ...
        public PersonEntityController(IMDSServices service, IHttpContextAccessor contextAccessor, ILogger<PersonEntityController> logger)
        {
            _service = service;
